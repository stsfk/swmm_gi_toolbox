...
The following figure shows that node J1 received higher flows than that generated by subcatchment S1, suggesting that J1 received exterally genereated runoffs.  The modeler can check the the catchment parameters or detailed simualation results to see if the toolbox worked as expected.
